...
class Usuario(TimestampMixin, Base):
    ...
    perfil: Mapped[Perfil] = mapped_column(Enum(Perfil, name="ck_usuarios_perfil", native_enum=False, create_constraint=True, length=32))
...
class Veiculo(TimestampMixin, Base):
    ...
    tipo: Mapped[TipoVeiculo] = mapped_column(Enum(TipoVeiculo, name="ck_veiculos_tipo", native_enum=False, create_constraint=True, length=32))
    status: Mapped[StatusVeiculo] = mapped_column(Enum(StatusVeiculo, name="ck_veiculos_status", native_enum=False, create_constraint=True, length=32), default=StatusVeiculo.DISPONIVEL)
...
class Rota(TimestampMixin, Base):
    ...
    motorista_id: Mapped[int | None] = mapped_column(ForeignKey("usuarios.id"), index=True)
    status: Mapped[StatusRota] = mapped_column(Enum(StatusRota, name="ck_rotas_status", native_enum=False, create_constraint=True, length=32), default=StatusRota.PLANEJADA)
...
class RotaAlternativa(TimestampMixin, Base):
    ...
    criterio: Mapped[CriterioAlternativaRota] = mapped_column(Enum(CriterioAlternativaRota, name="ck_rota_alternativas_criterio", native_enum=False, create_constraint=True, length=32), nullable=False)
...
class RotaEntrega(Base):
    ...
    prioridade: Mapped[Prioridade | None] = mapped_column(Enum(Prioridade, name="ck_rota_entregas_prioridade", native_enum=False, create_constraint=True, length=32))
...
class RotaHistorico(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    rota_id: Mapped[int] = mapped_column(ForeignKey("rotas.id"), index=True)
    evento: Mapped[TipoEventoRota] = mapped_column(Enum(TipoEventoRota, name="ck_rota_historico_evento", native_enum=False, create_constraint=True, length=32))
...
class Pedido(TimestampMixin, Base):
    ...
    status: Mapped[StatusPedido] = mapped_column(Enum(StatusPedido, name="ck_pedidos_status", native_enum=False, create_constraint=True, length=32), default=StatusPedido.ABERTO)
    prioridade: Mapped[Prioridade] = mapped_column(Enum(Prioridade, name="ck_pedidos_prioridade", native_enum=False, create_constraint=True, length=32), default=Prioridade.NORMAL)
...
class Entrega(TimestampMixin, Base):
    ...
    status: Mapped[StatusEntrega] = mapped_column(Enum(StatusEntrega, name="ck_entregas_status", native_enum=False, create_constraint=True, length=32), default=StatusEntrega.AGUARDANDO_COLETA)
